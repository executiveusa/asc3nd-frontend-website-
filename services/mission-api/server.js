...
const publicBridgeCors = cors({
  origin: true,
  credentials: false,
  methods: ['POST', 'OPTIONS'],
  allowedHeaders: ['Content-Type', 'x-mission-public-key', 'x-idempotency-key']
});
app.use((req, res, next) => {
  if (req.path.startsWith('/api/public/')) return publicBridgeCors(req, res, next);

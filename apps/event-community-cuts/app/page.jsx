      ...
      <section className={styles.hero} id="event">
        ...
        <div className={styles.heroPanel} aria-label="What families can expect">
          ...
          <div className={styles.featureList}>
            <article><span>01</span><div><h2>Free haircuts for kids</h2><p>A fresh start for the school year.</p></div></article>
            <article><span>02</span><div><h2>School supplies + giveaways</h2><p>Practical support for a prepared first day.</p></div></article>
            <article><span>03</span><div><h2>Food, fun + community</h2><p>A day to meet people, connect, and build together.</p></div></article>
          </div>
        </div>
      </section>

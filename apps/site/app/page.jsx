...
const pillars = [
  {
    icon: '👥',
    title: 'YOUTH FOCUSED',
    text: 'Building confidence, leadership and life skills.'
  },
  {
    icon: '🎓',
    title: 'FUTURE DRIVEN',
    text: 'Providing education, mentorship and real-world opportunities.'
  },
  {
    icon: '❤️',
    title: 'COMMUNITY BUILT',
    text: 'Strengthening families and creating lasting impact.'
  },
  {
    icon: '📈',
    title: 'TOGETHER WE ASC3ND',
    text: 'Uniting our community to elevate every generation.'
  }
];
...
const programCards = [
  {
    ...
    text: 'Tutoring, homework help, and academic resources to help youth succeed.',
    icon: '📘',
    emoji: '📚'
  },
  {
    title: 'MENTORSHIP',
    text: 'One-on-one mentorship that builds confidence, character and leadership.',
    icon: '🤝',
    emoji: '🤝'
  },
  {
    title: 'LEADERSHIP DEVELOPMENT',
    text: 'Equipping youth with the skills to lead, inspire and create change.',
    icon: '💡',
    emoji: '💡'
  },
  {
    title: 'COMMUNITY ENGAGEMENT',
    text: 'Service projects and community initiatives that create impact and build unity.',
    icon: '🫶',
    emoji: '🫶'
  },
  {
    title: 'LIFE SKILLS & WELLNESS',
    text: 'Workshops and resources that support mental health, wellness and resilience.',
    icon: '⭐',
    emoji: '⭐'
  }
];
          ...
          <div className="hp-container hp-split">
            <div className="hp-who-image">
              <img
                ...
                alt="Asc3nd Collective youth working together on a vision board saying Leaders Create, Dream Plan ASC3ND"
                loading="lazy"
              />
            </div>
        ...
        <section className="hp-cta-band" id="get-involved" aria-labelledby="cta-heading">
          <div className="hp-container hp-cta-inner">
            <div className="hp-cta-copy">
              ...
              <p>
                Whether you volunteer, donate, mentor or partner with us—your support helps us empower youth and transform communities.
              </p>
            </div>
